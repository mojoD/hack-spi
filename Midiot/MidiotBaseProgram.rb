...
def buildGMSampleArray(gmDirIn, gmBank, gmPatch)
  ...
  #puts "sGMFileName: " + sGMFileName.to_s
  ...
  sGMArray.each do |gMLine|
    ...
    #puts "gMLine: " + gMLine.to_s
    #puts "sGMPatch: " + sGMPatch.to_s
    #puts "mProgType: " + mProgType.to_s
    #puts "sGMBank: " + sGMBank.to_s
    #puts "mBankType: " + mBankType.to_s 
