...
presetFile = defaultSoundFontDir + ".presets.info"
f = File.open(presetFile,'r')
presetInArray = f.readlines
f.close

paramsFile = defaultSoundFontDir + ".params.info"
...
numoftimes.times do |i|
  ...
  looperfile.puts "noteArray" + i.to_s +  " = buildMidiNotes(midiIn" + i.to_s + ").ring; timingArray" + i.to_s + " = buildMidiTiming(midiIn" + i.to_s + ").ring; releaseArray" + i.to_s + " = buildMidiRelease(midiIn" + i.to_s + ").ring;"
  sequencerfile.puts "noteArray" + i.to_s +  " = buildMidiNotes(midiIn" + i.to_s + ").ring; timingArray" + i.to_s + " = buildMidiTiming(midiIn" + i.to_s + ").ring; releaseArray" + i.to_s + " = buildMidiRelease(midiIn" + i.to_s + ").ring;"
  ...
  looperfile.puts '      instrument noteArray' + i.to_s + '[i].to_i, duration: releaseArray' + i.to_s + '[i].to_f, gmBank: ' + gmBank.to_s.strip + ', gmPatch: ' + gmPatch.to_s.strip + ", gmPathDir: gmPathDir, bpm: bpm, amp: " + amp.to_s.strip + ", release: " + rlse.to_s + ", lpf: " + lpf.to_s.strip
  sequencerfile.puts '      instrument noteArray' + i.to_s + '[i].to_i, duration: releaseArray' + i.to_s + '[i].to_f, gmBank: ' + gmBank.to_s.strip + ', gmPatch: ' + gmPatch.to_s.strip + ", gmPathDir: gmPathDir, bpm: bpm, amp: " + amp.to_s.strip + ", release: " + rlse.to_s + ", lpf: " + lpf.to_s.strip
