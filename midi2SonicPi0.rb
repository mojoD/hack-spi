...
sequencerfile.puts 'load_synthdefs "C:/Users/Michael Sutton/Desktop/my-synths/"'
...
numoftimes.times do |i|
  ...
  looperfile.puts 'load_synthdefs "C:/Users/Michael Sutton/Desktop/my-synths/"'
  ...
  looperfile.puts "      midiIn = readMidiLoop(mloopDir: mloopDir, mloop: mloops" + i.to_s +  ", sliceBegin: " + sBeg.to_s.strip + ", sliceEnd: " + sEnd.to_s.strip + ", transpose: " + trn.to_s.strip + ")"  
  sequencerfile.puts "      midiIn = readMidiLoop(mloopDir: mloopDir, mloop: mloops" + i.to_s +  ", sliceBegin: " + sBeg.to_s.strip + ", sliceEnd: " + sEnd.to_s.strip + ", transpose: " + trn.to_s.strip + ")"    
  looperfile.puts '      instrument midiIn, gmBank: ' + gmBank.to_s.strip + ', gmPatch: ' + gmPatch.to_s.strip + ", gmPathDir: gmPathDir, bpm: bpm, amp: " + amp.to_s.strip + ", release: " + rlse.to_s.strip + ", lpf: " + lpf.to_s.strip
  sequencerfile.puts '      instrument midiIn, gmBank: ' + gmBank.to_s.strip + ', gmPatch: ' + gmPatch.to_s.strip + ", gmPathDir: gmPathDir, bpm: bpm, amp: " + amp.to_s.strip + ", release: " + rlse.to_s.strip + ", lpf: " + lpf.to_s.strip
  looperfile.puts "      sleep 1" 
  sequencerfile.puts "      sleep 1" 
